                ...
                html: `
                    ...
                    <body style="font-family: Arial, sans-serif; color: #333; margin: 0; padding: 0;">
                        <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9; box-sizing: border-box;">
                            <img src="https://res.cloudinary.com/dohzhn0ny/image/upload/v1724655493/zk5mgddyoi40k2yemfru.png" alt="MAMA LOVELY TOY LOGO" style="display: block; margin: 0 auto; width: 200px;"/>
